<h2> Manga Recommendation System(Streamlit library + kaggle dataset) </h2>
...
This is a content-based recommendation system, content Based Recommender System recommends manga's similar to the mange user likes.Libraries used Scikit-learn and NLTK.
